  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">Política de Privacidade</h1>
        ...
        <div className="space-y-10 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">1. Quem somos</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">2. Dados que recolhemos</h2>
            <div className="space-y-3">
              <div className="p-4 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border)]">
                <p className="text-[var(--text-primary)] font-medium text-sm mb-1">Dados da conta</p>
                <p className="text-xs">Nome, endereço de email e palavra-passe (armazenada de forma encriptada).</p>
              </div>
              <div className="p-4 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border)]">
                <p className="text-[var(--text-primary)] font-medium text-sm mb-1">Dados de perfil desportivo</p>
              ...
              <div className="p-4 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border)]">
                <p className="text-[var(--text-primary)] font-medium text-sm mb-1">Dados de treino</p>
              ...
              <div className="p-4 rounded-xl bg-[var(--bg-subtle)] border border-[var(--border)]">
                <p className="text-[var(--text-primary)] font-medium text-sm mb-1">Dados de bem-estar</p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">3. Como usamos os teus dados</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">4. Cookies</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">5. Os teus direitos (RGPD)</h2>
            <p className="text-sm mb-3">
              Ao abrigo do Regulamento Geral de Proteção de Dados (RGPD), tens os seguintes direitos:
            </p>
            <ul className="space-y-2 text-sm list-disc list-inside">
              <li><span className="text-[var(--text-primary)] font-medium">Acesso</span> — podes solicitar uma cópia dos teus dados</li>
              <li><span className="text-[var(--text-primary)] font-medium">Retificação</span> — podes corrigir dados incorretos no teu perfil</li>
              <li><span className="text-[var(--text-primary)] font-medium">Eliminação</span> — podes eliminar a tua conta e todos os dados associados a qualquer momento</li>
              <li><span className="text-[var(--text-primary)] font-medium">Portabilidade</span> — podes exportar os teus dados em formato TCX</li>
              <li><span className="text-[var(--text-primary)] font-medium">Oposição</span> — podes opor-te ao tratamento dos teus dados contactando-nos</li>
            </ul>
            <p className="mt-3 text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">6. Segurança</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">7. Retenção de dados</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">8. Alterações a esta política</h2>
            <p className="text-sm">
