    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      <header className="sticky top-0 z-40 border-b border-[#1a1a1a] backdrop-blur-xl bg-black/60 px-6 py-3">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <LogoFull size={30} />
          <Link href="/dashboard/profile" className="text-zinc-500 hover:text-zinc-300 text-sm transition-colors">← Perfil</Link>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-1">Os dados de FC e pace melhoram a precisão dos planos gerados por IA</p>
        </div>
