  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">Termos de Serviço</h1>
        ...
        <div className="space-y-10 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">1. Aceitação dos termos</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">2. Descrição do serviço</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">3. Aviso médico</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">4. Registo e conta</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">5. Utilização aceitável</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">6. Integrações de terceiros</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">7. Propriedade intelectual</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">8. Limitação de responsabilidade</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">9. Cancelamento e eliminação</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">10. Lei aplicável</h2>
            <p className="text-sm">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">11. Contacto</h2>
            <p className="text-sm">
