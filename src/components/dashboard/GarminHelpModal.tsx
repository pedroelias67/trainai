    ...
    <>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="w-7 h-7 rounded-xl border border-[#2a2a2a] bg-[#161616] text-zinc-500 hover:text-white hover:border-[#3a3a3a] transition-all text-xs font-bold flex items-center justify-center"
        >
          ?
        </button>
      </div>
      ...
      {showHelp && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/70 backdrop-blur-sm"
          ...
          <div className="w-full max-w-md bg-[#111] border border-[#222] rounded-2xl p-6 space-y-5">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[#1a1a1a] border border-[#2a2a2a] text-zinc-300 hover:text-white text-sm font-medium transition-colors"
            >
              Fechar
            </button>
          </div>
